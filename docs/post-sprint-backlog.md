...
category: meta
status: living
last_updated: 2026-06-15 (3 new multiplayer items + 2 UX priority bumps from Henrik+Johan session; rc race promoted to High with planned fix A+B+C; 4 new networking-stabilization items added from `docs/networking-stabilization-plan.md`)
sections:
  - About this backlog
  - Conventions
