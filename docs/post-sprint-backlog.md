...
category: meta
status: living
last_updated: 2026-06-15 (3 new multiplayer items + 2 UX priority bumps from Henrik+Johan session; rc race promoted to High with planned fix A+B+C; 4 new networking-stabilization items added from `docs/networking-stabilization-plan.md`; same-LAN hairpin-NAT note added after L2 hotspot test passed G1–G9 twice in a row)
sections:
  - About this backlog
  - Conventions
